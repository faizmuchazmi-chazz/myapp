...
$config['join'][$config['tables']['users']]  = 'user_id';
 ...
 */
$config['site_title']                 = 'JOSS!';       // Site Title, example.com
$config['admin_email']                = "sekretariat.pasidoarjo@gmail.com"; // Admin Email, admin@example.com
...
$config['user_expire']                = 2592000;             // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration (30 days = 30 * 24 * 60 * 60)
